...
func (setup *FabricSetup) InstallAndInstantiateCC() error {
	...
	installCCReq := resmgmt.InstallCCRequest{Name: setup.ChainCodeID, Path: setup.ChaincodePath, Version: "1.1", Package: ccPkg}
	...
	err = setup.admin.InstantiateCC(setup.ChannelID, resmgmt.InstantiateCCRequest{Name: setup.ChainCodeID, Path: setup.ChaincodePath, Version: "1.1", Args: [][]byte{[]byte("init")}, Policy: ccPolicy})
	if err != nil {
